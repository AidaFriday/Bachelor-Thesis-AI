\section{Benchmarking Parameters (accuracy, latency, FPS, memory)}
\section{Evaluation Setup (CPU vs GPU, datasets, webcam)}
\section{Application Workflow (PyQt GUI, integration)}
